...
| [Wilson-Loewner](investigations/wilson-loewner/README.md) · [exposition](investigations/wilson-loewner/manuscript.pdf) · [supplement](investigations/wilson-loewner/supplementary-information.pdf) · [drafts](investigations/wilson-loewner/drafts/README.md) · [notes](investigations/wilson-loewner/notes/README.md) | Working manuscript pair 0.3: a 16-page exposition organized around the prescribed shifted-zeta evolution, cumulative positivity and depth--shift continuation, with a 26-page technical companion. The companion retains the free-kernel, contour, variation, chiral-projector, endpoint, reflection and bulk-response tools, and gives the inherited continuation algebra. The physical realization, norm identity and all-depth bounds remain open. Historical unified versions 0.1 and 0.2 are preserved; 268 finite diagnostics and both-document build records accompany the pair. No independent review. |
