...
- [Critical path](investigations/critical-path/README.md): the next investigation, with only a placeholder during this organizational change.
- [Wilson–Loewner](investigations/wilson-loewner/README.md): working manuscript 0.2 (27 pages), its preserved drafts, and the [shift-flow, cumulative-storage and critical-path note](investigations/wilson-loewner/notes/SHIFT_FLOW_CUMULATIVE_STORAGE_AND_CRITICAL_PATH_20260919.md).
...
susy-positivity/
  ...
  investigations/                # current research focus
    critical-path/               # placeholder for the next investigation
    wilson-loewner/
    wilson-lines/
    loewner/
...
| Investigation | Scope and status |
|---|---|
| [Critical path](investigations/critical-path/README.md) | New investigation reserved for the next task; placeholder only, linked to the 19 September Wilson–Loewner shift-flow and cumulative-storage note. |
| [Wilson-Loewner](investigations/wilson-loewner/README.md) · [PDF](investigations/wilson-loewner/manuscript.pdf) · [drafts](investigations/wilson-loewner/drafts/README.md) · [notes](investigations/wilson-loewner/notes/README.md) | Working manuscript 0.2 (27 pages), *Wilson lines on Loewner-generated contours: defect supersymmetry, reflection, and endpoint positivity*. Self-contained RH target and literature background, constant-driver semicircle dictionary and restricted rigidity, exact smooth Wilson variation, and full chiral defect projectors for tangent-coupled contours. The same-charge scalar endpoint pairing vanishes. Ordinary time reflection supplies a positive free opposite-ray kernel with different branch charges and a conditional interacting Gram construction. A smooth reference join has a finite nonzero direct bulk response with coefficient 3/2 - 2 log 2; endpoint, defect and junction contributions remain open. An internal rotation aligning the connections fails positivity on the free endpoint doublet. Two dated snapshots, build provenance and 268 finite diagnostics. No independent review, complete arithmetic realization or interacting positivity proof. |
