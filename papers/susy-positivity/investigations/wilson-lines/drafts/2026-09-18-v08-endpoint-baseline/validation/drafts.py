...
CHECKS = {
    "check_causal_commutation.py": "causal-commutation-checks.json",
    "check_sampling_forms.py": "sampling-forms-checks.json",
    "check_delay_test.py": "delay-test-checks.json",
}
...
def record_build(args):
    ...
    record = {
        "schema": 1,
        "title": "A jump-process presentation of the localized Weil form",
...
def save_snapshot(args):
    ...
    with tempfile.TemporaryDirectory(prefix="draft-stage-") as temporary:
        ...
        (prepared / "README.md").write_text(
            ...
            "Historical snapshot of *A jump-process presentation of the localized Weil form*.\n\n"
