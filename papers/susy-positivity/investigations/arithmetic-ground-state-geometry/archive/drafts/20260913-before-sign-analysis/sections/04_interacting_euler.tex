...
Interactions can therefore preserve an exact arithmetic local factor.
To constrain the missing pairing one needs more than the field
dilation in \eqref{qua:trivial-class}. Section~\ref{sec:shape}
provides a genuine shape deformation, and Section~\ref{sec:caps}
constructs a normalized physical source in a different Jacobi class.
