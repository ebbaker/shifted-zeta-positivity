...
A common source rule compatible under enlargement of $I_L$ is a natural
requirement for one field-theoretic realization. Separate positive
realizations for every $L$ would already suffice logically for RH; their
compatibility is additional structure, not an extra premise of the Weil
criterion. A mass gap is not needed for the elementary norm implication.
