...
Suzuki's account of the Weil form \cite[Section 1.1]{Suzuki}, whose
unconditional results on the lowest eigenvalue of the localized form are
recorded in Remark~\ref{rem:suzuki}; for its geometric and trace interpretation
see \cite{CCM}.
