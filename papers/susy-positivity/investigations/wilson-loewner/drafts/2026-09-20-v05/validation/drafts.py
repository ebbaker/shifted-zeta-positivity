...
CHECKS = {
    ...
    "check_fixed_window_response.py": "fixed-window-response-checks.json",
}
...
def record_build(args):
    ...
    # Separate research formats: preserve identity and include them in the
    # standalone snapshot without relabeling the original 299-case ledger.
