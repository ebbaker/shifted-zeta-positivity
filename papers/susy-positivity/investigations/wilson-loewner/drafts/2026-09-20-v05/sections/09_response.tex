...
\subsection{The complete response still required}


For an interacting candidate that survives the normalized response
and localization-compatibility tests of
Sections~\ref{sec:fixed-response}--\ref{sec:localization}, a further
requirement is the complete first interaction-order shape response of \eqref{eq:network}, beginning with a positive bulge
