...
estimate \cite{EMAAnchor,CumulativeAppend}. It supplies no new
all-input upper bound for the normalized coupling. The full program and hypotheses are in the
