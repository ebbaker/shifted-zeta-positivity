\section{Arithmetic conventions and exact kernel factorization}\label{sec:arithmetic}

We repeat the arithmetic normalization to make this companion
independently readable. The effective-evolution hypothesis and its
role in the program are stated in the exposition~\cite{Exposition}.
The free defect calculations below use the exponential tower
