...
The [current exposition](../manuscript.pdf) and [supplementary information](../supplementary-information.pdf) can evolve. A dated snapshot is
preserved unchanged and can be copied elsewhere to build and replay without
the parent investigations. See the [build guide](../BUILD.md). Creating a
new version never overwrites an existing snapshot.
