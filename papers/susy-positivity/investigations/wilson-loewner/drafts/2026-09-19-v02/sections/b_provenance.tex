...
The first manuscript version was assembled on 19 September 2026
...
Version 0.2 makes the archimedean decomposition in
Section~\ref{sec:arithmetic} explicit, displaying both the constant
remainder and the resulting full Weil form. This exposition revision
was prepared by OpenAI GPT-6 (Codex), for Edward Baker, on the same date.
