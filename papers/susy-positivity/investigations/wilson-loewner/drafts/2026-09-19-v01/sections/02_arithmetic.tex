...
\end{equation}
The series follows by subtracting the convergent digamma partial
...
\end{equation}
Consequently the first line of \eqref{eq:weil}, before its pole term,
is $\mathcal E_\Gamma[F]+w_0\norm f_2^2$. The positive difference energy
is only one part of the desired form.
