...
The [cross-theory lessons note](notes/LESSONS_FROM_WZW_FOR_YM_AND_N4SYM_20260923.md) applies the WZW and later response tests to the parent YM/SYM program. A new [N4SYM investigation](N4SYM/README.md) contains a detailed proposal for displacement-operator response, genuine Loewner growth and physical energy accounting. These are research notes and a proposal; no new physical realization or numerical result is claimed.
