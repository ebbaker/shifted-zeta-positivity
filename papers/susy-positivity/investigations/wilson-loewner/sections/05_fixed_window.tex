...
\cite[Sections~S10--S11]{Supplement}.
...
The useful next calculation is whether a defect-compatible
supercharge, boundary conditions and observable produce these
surviving contributions and the required finite normalization.
