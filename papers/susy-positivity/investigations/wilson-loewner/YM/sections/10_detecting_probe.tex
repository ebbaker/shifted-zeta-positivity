...
Its correlation hypothesis already implies RH, as the proof explicitly
uses. It reduces the data to establish, with no demonstrated reduction
in difficulty. Its research value depends on deriving the correlation
from independently specified physical observables or principles.
