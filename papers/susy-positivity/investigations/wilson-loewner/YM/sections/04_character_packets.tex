...
are multiplication by $\chi_a$ composed with the Adams operation
$F(g)\mapsto F(g^a)$; the two operations must be distinguished. They
...
The normalized limit \eqref{eq:prime-mixed} is universal over the
stated positive marginals, whereas \eqref{eq:wound-mixed} and
\eqref{eq:wound-norm} retain their displayed state dependence.
