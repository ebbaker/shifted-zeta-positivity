...
Section 7.3.2.
\bibitem{bekaert-boulanger}
X. Bekaert and N. Boulanger,
\emph{The unitary representations of the Poincar\'e group
in any spacetime dimension}, lecture notes, version 2 (2021).
\href{https://arxiv.org/abs/hep-th/0611263}{arXiv:hep-th/0611263}.
The spacetime spectral-type assertion used here is also
proved directly in Lemma~\ref{lem:spacetime-ac}.

\bibitem{hormander-spectral}
L. H\"ormander, \emph{The spectral function of an elliptic operator},
Acta Mathematica \textbf{121} (1968), 193--218.
\href{https://doi.org/10.1007/BF02391913}{doi:10.1007/BF02391913}.

\bibitem{ramacher}
P. Ramacher, \emph{The equivariant spectral function of an invariant
elliptic operator. $L^p$-bounds, caustics, and concentration of
eigenfunctions}, version 3 (2017).
\href{https://arxiv.org/abs/1512.02193}{arXiv:1512.02193},
Theorem 4.3 and the principal-orbit discussion.
