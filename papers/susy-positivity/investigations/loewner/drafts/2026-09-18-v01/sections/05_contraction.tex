...
Proposition~\ref{prop:bessel} is a statement about $e^{-2\tau}$. A realization
of the archimedean factor by a radial chain (Section~\ref{sec:outlook}) must
therefore produce $e^{-2\tau}$ Beta-distributed, not merely an additivity
fraction somewhere.
\end{remark}
