...
CHECKS = {
    "check_matching.py": "matching-checks.json",
    "check_gauge_transfer.py": "gauge-transfer-checks.json",
    "check_sphere_schur.py": "sphere-schur-checks.json",
    "check_dressed_schur.py": "dressed-schur-checks.json",
...
def record_build(args):
    ...
    record = {
        "schema": 1,
        "title": "Sphere and Schur sources for the localized Weil form",
...
def save_snapshot(args):
    ...
    with tempfile.TemporaryDirectory(prefix="draft-stage-") as temporary:
        ...
        (prepared / "README.md").write_text(
            ...
            "Historical snapshot of *Sphere and Schur sources for the localized Weil form*.\n\n"
