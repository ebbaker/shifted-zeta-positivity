...
The author suggested searching for a critical path as one decreases the shift and increases the depth in order to find a recursive argument along that path. 
