...
The preprint in this folder (PDF and LaTeX source) and its accompanying
documentation are licensed under the **Creative Commons Attribution 4.0
International License (CC BY 4.0)**, as stated in the repository's
dual-license notice (`../../../LICENSE`): text under CC BY 4.0, code under MIT.
